 ...
 */
package com.jooqpoc.model.tables;
...
import com.jooqpoc.model.tables.records.ClientRecord;
...
public class Client extends TableImpl<ClientRecord> {
	 ...
	 */
	public final TableField<ClientRecord, String> FIRST_NAME = createField("first_name",
			org.jooq.impl.SQLDataType.VARCHAR.length(100).nullable(false), this, "");

	/**
	 * The column <code>library.client.last_name</code>.
	 */
	public final TableField<ClientRecord, String> LAST_NAME = createField("last_name",
